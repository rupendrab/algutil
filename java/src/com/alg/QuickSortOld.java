...
public class QuickSortOld<T extends Comparable<T>>
{
    T[] items;
    int itemCount;
    boolean inPlace;
    ...
    public QuickSortOld(T[] items, boolean inPlace)
    {
        super();
        this.items = items;
    ...
    public QuickSortOld(T[] items, boolean inPlace, Class<T> clazz)
    {
        this(items, inPlace);
        this.clazz = clazz;
    }
    ...
    public static void basicTest()
    {
        ...
        QuickSortOld<Integer> qs = new QuickSortOld<>(arr, true);
    ...
    public static void perfTest()
    {
        ...
        QuickSortOld<Integer> qs = new QuickSortOld<>(toSort, true);
